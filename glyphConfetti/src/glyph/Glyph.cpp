...
//  Libraries holdes for the elements
//
vector<Limb> limbLibrary;       //  Basic Limb Shapes
vector<ofColor> colorLibrary;   //  Basic Colors 
...
//    }
    ...
    //  Rotate 90 randomly to all the limbs
    //
    //if (ofRandom(0,1) > 0.5){
        for (int i = 0; i < limbLibrary.size(); i++){
            for (int j = 0; j < limbLibrary[i].coords().size(); j++){
